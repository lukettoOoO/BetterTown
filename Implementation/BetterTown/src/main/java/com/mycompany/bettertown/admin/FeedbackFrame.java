...
public class FeedbackFrame extends javax.swing.JFrame {
    ...
    public FeedbackFrame(ProfileData admin) {
        ...
        {average=0;}
        double scaledAverage = average * 100; 
        long truncatedScaledAverage = (long) scaledAverage;
        double finalAverage = truncatedScaledAverage / 100.0;
        Rating.setText(String.valueOf(finalAverage));
