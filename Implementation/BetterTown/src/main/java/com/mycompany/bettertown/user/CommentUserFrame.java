...
public class CommentUserFrame extends javax.swing.JFrame {
    ...
    private List<Comment> loadedComments = new ArrayList<Comment>();
        ...
        public void valueChanged(ListSelectionEvent e) {
            if (!e.getValueIsAdjusting()) {
                ...
                if (selectedIndex >= 0 && selectedIndex < loadedComments.size()) {
                    Comment selected = loadedComments.get(selectedIndex);
    ...
    private void initComponents() {
        ...
        CommentsViewList.getAccessibleContext().setAccessibleParent(CommentScrollAdd);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(CommentsViewScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 345, Short.MAX_VALUE))
                .addContainerGap())
